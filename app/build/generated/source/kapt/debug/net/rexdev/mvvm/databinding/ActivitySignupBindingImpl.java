...
public class ActivitySignupBindingImpl extends ActivitySignupBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.edit_text_name, 4);
        sViewsWithIds.put(R.id.edit_text_email, 5);
        sViewsWithIds.put(R.id.edit_text_password, 6);
        sViewsWithIds.put(R.id.edit_text_password_confirm, 7);
        sViewsWithIds.put(R.id.text_view_forget_password, 8);
        sViewsWithIds.put(R.id.button_sign_up, 9);
        sViewsWithIds.put(R.id.text_view_login, 10);
